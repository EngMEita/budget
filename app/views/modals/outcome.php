<div id="addOutcome" class="modal fade" role="dialog">
    <?=form_open('acc/save')?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><strong>إضافة مصروف</strong></h4>
            </div>
            <div class="modal-body">
                <div class="form-group row">
                    <div class="col-sm-3">المبلغ: </div>
                    <div class="col-sm-9"><input type="text" name="frm_data[rec_credit]" class="form-control money"
